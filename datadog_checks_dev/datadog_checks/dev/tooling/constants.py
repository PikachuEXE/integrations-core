...
AGENT_REQ_FILE_NAME = 'requirements-agent-release.txt'
...
class __MutableString(UserString, str):
    pass


# Allow these constants to be referenced like a
# str and also modifiable for configuration.
ROOT = __MutableString('')
AGENT_REQ_FILE = __MutableString(AGENT_REQ_FILE_NAME)


def set_root(path):
    ROOT.data = path
    AGENT_REQ_FILE.data = join(path, AGENT_REQ_FILE_NAME)
